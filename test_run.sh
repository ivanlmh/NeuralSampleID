...
# python test_fp.py --query_lens=1,2,3,5 --n_query_db=100 --n_dummy_db=400 --test_snr=10 --test_dir=/data/EECS-Studiosync/fma_small --text=ivan_old_test_for_comparison